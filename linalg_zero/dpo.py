...
from linalg_zero.dpo.utils import load_dataset_for_dpo
...
def main(script_args: ScriptArguments, training_args: DPOConfig, model_args: ModelConfig) -> None:  # noqa: C901
    ...
    dataset = load_dataset_for_dpo(script_args)
...
if __name__ == "__main__":
    """Script entry point for DPO training."""
