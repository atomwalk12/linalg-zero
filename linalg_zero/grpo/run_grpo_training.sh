...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.fsdp_config.model_dtype=bfloat16 \ # alternative fp32
    actor_rollout_ref.model.enable_gradient_checkpointing=True \
    ...
    actor_rollout_ref.rollout.max_model_len=12288 \ # 8192 + 4096
    ...
    trainer.total_epochs=15 $@ 2>&1 | tee ${WANDB_EXP}.log
